...
$id_site = 'default'; // ID do site encontrado na URL (https://1.1.1.1:8443/manage/site/<site_ID>/devices/1/50)
...
// Consulta no banco de dados para verificar CPF e senha
...
if ($result->num_rows > 0) {
    ...
    echo "Usuário não encontrado. Por favor, verifique o CPF e a senha.";
}
